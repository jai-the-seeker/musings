...
After our containers are up, let us check the connectivity of mysql. Create [check-conn.php]() file and place it in appropriate location. Now, we can visit this page to verify our connectivity with the database.
